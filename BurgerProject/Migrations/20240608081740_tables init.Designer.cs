...
namespace BurgerProject.Migrations
{
    ...
    [Migration("20240608081740_tables init")]
            ...
            modelBuilder.Entity("BurgerProject.Data.Entities.Concrete.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "eef9c7ed-da20-4ec1-ba75-b759d0398036",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEP6UuD4+REuHKlQbzpHUqYdlBdazDd8+3U8Wjz7VP0gv2MeMW0M8f/XYzGHhOMTFvw==",
